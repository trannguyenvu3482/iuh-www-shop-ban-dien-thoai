            ...
            >
              {({
                ...
                <form
                  ...
                  className="mx-auto rounded-lg border-b bg-white px-2 py-6"
                >
                  {/* <h3 className="text-md mb-2 font-bold uppercase">
                Thông tin khách hàng
              </h3> */}
                  <div className="mb-4 flex w-full border-b-[1px] border-gray-300 pb-2">
                    <span className="font-bold uppercase text-gray-800">
                      Thông tin khách hàng
                    </span>
                  </div>
                  ...
                  <p className="mb-4 text-sm text-gray-600">
                    Chọn phương thức nhận hàng sẽ giúp bạn nhận được sản phẩm
                    nhanh hơn
                  </p>
                  <div className="flex gap-4">
                    <button
          ...
          <div className="flex h-[400px] w-full flex-col justify-between rounded-2xl">
            <div className="flex-1 rounded-t-2xl bg-white p-6 pb-0">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button className="mt-4 w-full rounded-lg bg-red-600 p-4 text-white hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-300">
                  Xác nhận đơn hàng
                </button>
              </div>
            </div>

  ...
  return (
    <header>
      ...
      <div className="bg-primary-red">
        <div className="mx-auto max-w-[1200px] pb-2">
          <div className="top flex py-[10px]">
            <a className="flex h-fit" href="/">
              <img className="mr-2 w-[172px] pl-2 pt-2" src={logo} alt="logo" />
            </a>
            ...
            <div className="stores relative ml-6">
              ...
              <div
                className={`${
                  !showShowroom && 'hidden'
                } list-showroom absolute left-0 top-[105%] w-[370px] rounded-md bg-white pb-1 text-xs drop-shadow-sm`}
              >
                <div className="p-2">
                  <ul>

    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .cors(httpSecurityCorsConfigurer -> {
                    ...
                    configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://localhost:3000", "https://localhost:8080", "https://iuh-www-shop-ban-dien-thoai.vercel.app"));
                ...
                .authorizeHttpRequests(
                        authz -> authz
                                ...
                                .requestMatchers("/", "api/v1/auth/**", "api/v1/create-order/**", "/api-docs/**", "/swagger-ui/**", "/v3/api-docs/**", "api/v1/products/**", "api/v1/categories/**", "api/v1/payment/**").permitAll()

package com.fit.se.app.common.constants;

public class VnPayConstant {

    public static final String VNP_PAY_URL = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    public static final String VNP_RETURN_URL = "http://localhost:8080/api/create-order/callback";
    ...
    public static final String VNP_BANK_CODE = "";
